...
CREATE TABLE IF NOT EXISTS `cleanup` (
  ...
  PRIMARY KEY (`uid`)
) ENGINE=InnoDB AUTO_INCREMENT=53682 DEFAULT CHARSET=utf8mb4 ENCRYPTION='N';
...
CREATE TABLE IF NOT EXISTS `configs` (
  ...
  `verifyask` mediumtext CHARACTER SET utf16 COLLATE utf16_unicode_ci NOT NULL DEFAULT '',
  `verifymessage` text CHARACTER SET utf8 NOT NULL DEFAULT '',
  `mediadelay` tinyint(1) DEFAULT '0',
  `mediadelaytime` int(11) DEFAULT '30',
  `dontdeletejoinmessage` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`groupid`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf32 ENCRYPTION='N';
...
CREATE TABLE IF NOT EXISTS `removals` (
  ...
  PRIMARY KEY (`uid`)
) ENGINE=InnoDB AUTO_INCREMENT=25915 DEFAULT CHARSET=utf8mb4 ENCRYPTION='N';
...
CREATE TABLE IF NOT EXISTS `verify` (
  ...
  PRIMARY KEY (`uid`)
) ENGINE=InnoDB AUTO_INCREMENT=47316 DEFAULT CHARSET=utf8mb4 ENCRYPTION='N';
