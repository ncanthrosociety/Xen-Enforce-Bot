...
namespace XenfbotDN
{
    internal static class Telegram
    {
        ...
        {
            if (secondsDuration < 30 && secondsDuration != 0) secondsDuration = 35; // Prevent accidental permaban.
        ...
        public static TGMessage sendMessage(TGChat chat, string message)
        {
            ...
            if (resp.ok) return serializer.Deserialize<TGMessage>(resp.result.CreateReader());
        ...
        public static TGUser getMe()
        {
            ...
            if (resp.ok) return serializer.Deserialize<TGUser>(resp.result.CreateReader());
        ...
        public static TGMessage sendMessage(TGChat chat, string message, string parse_mode)
        {
            ...
            var resp = apiGetRequest("sendMessage", b);
            var rede = resp.result.CreateReader();
            if (resp.ok) return serializer.Deserialize<TGMessage>(rede);
